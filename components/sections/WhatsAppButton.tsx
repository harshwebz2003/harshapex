  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-[30px] right-[30px] w-[56px] h-[56px] bg-gradient-to-br from-[#25d366] to-[#128c7e] rounded-full flex items-center justify-center z-[999] transition-all duration-300 hover:scale-[1.06] active:scale-[0.96] group luxury-whatsapp-aura cursor-pointer"
      >
        ...
        <span className="absolute right-[70px] bg-[#0D0B1A]/95 text-white px-3.5 py-1.5 rounded-full text-[11px] font-medium tracking-wide whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0 pointer-events-none border border-white/10 shadow-xl font-mono">
          Direct Line
        </span>
      </a>
    </>
